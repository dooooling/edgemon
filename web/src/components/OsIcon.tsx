...
export const OsIcon: React.FC<OsIconProps> = ({
  ...
  const c = (brandColor: string) => (monochrome ? 'currentColor' : brandColor);

  switch (osType) {
    case 'windows':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#00ADEF')}>
    ...
    case 'ubuntu':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#E95420')}>
    ...
    case 'debian':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#D70A53')}>
      ...
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24">
            {/* Top orange quadrant */}
            <path fill={c('#FFA500')} d="M12 2.5l2.25 4.5H9.75L12 2.5zm0 5l1.25 2.5H10.75L12 7.5z" />
            <path fill={c('#FFA500')} d="M7.25 7.25l3.5 1.25-1.25 3.5-3.5-1.25 1.25-3.5z" />
            {/* Right green quadrant */}
            <path fill={c('#92D050')} d="M21.5 12l-4.5 2.25v-4.5L21.5 12zm-5 0l-2.5 1.25v-2.5L16.5 12z" />
            <path fill={c('#92D050')} d="M16.75 7.25l1.25 3.5-3.5 1.25-1.25-3.5 3.5-1.25z" />
            {/* Bottom blue quadrant */}
            <path fill={c('#2B82D9')} d="M12 21.5l-2.25-4.5h4.5L12 21.5zm0-5l-1.25-2.5h2.5L12 16.5z" />
            <path fill={c('#2B82D9')} d="M16.75 16.75l-3.5 1.25 1.25-3.5 3.5 1.25-1.25 3.5z" />
            {/* Left purple quadrant */}
            <path fill={c('#94389E')} d="M2.5 12l4.5-2.25v4.5L2.5 12zm5 0l2.5-1.25v2.5L7.5 12z" />
            <path fill={c('#94389E')} d="M7.25 16.75l-1.25-3.5 3.5-1.25 1.25 3.5-3.5 1.25z" />
          </svg>
        </span>
      );
    ...
    case 'rocky':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#10B981')}>
    ...
    case 'almalinux':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#3164F4')}>
    ...
    case 'rhel':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#EE0000')}>
    ...
    case 'alpine':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#0D597F')}>
    ...
    case 'arch':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#1793D1')}>
    ...
    case 'fedora':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#51A2DA')}>
    ...
    case 'opensuse':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#73BA25')}>
    ...
    case 'macos':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#E5E5EA')}>
    ...
    case 'freebsd':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#AB2B28')}>
    ...
    case 'linux':
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#F5A623')}>
    ...
    default:
      return (
        <span className={className} style={containerStyle} title={defaultTitle}>
          <svg width={size} height={size} viewBox="0 0 24 24" fill={c('#38BDF8')}>
