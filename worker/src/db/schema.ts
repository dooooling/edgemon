...
export async function ensureSchema(db: D1Database): Promise<void> {
  ...
  const sqlStatements = [
    ...
    `CREATE TABLE IF NOT EXISTS nodes (
      ...
      as_org TEXT,
      cf_colo TEXT,
      location_mode TEXT NOT NULL DEFAULT 'auto' CHECK (location_mode IN ('auto','manual')),
      manual_country TEXT,
      manual_city TEXT,
      manual_lat REAL,
      manual_lon REAL,
    ...
    `CREATE TABLE IF NOT EXISTS node_state (
      ...
      rx_bps INTEGER,
      tx_bps INTEGER,
      rx_total_bytes INTEGER NOT NULL,
      tx_total_bytes INTEGER NOT NULL,
      edge_rtt_ms REAL,
      edge_transport TEXT,
      uptime_sec INTEGER,
  ...
  try {
    ...
    console.error('Failed to auto-ensure schema:', err);
  }
}
